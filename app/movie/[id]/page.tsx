...
import { getMovieDetails, getSimilarMovies, getBackdropUrl, getImageUrl, getMovieVideos } from "@/lib/tmdb"
...
import { TrailerButton } from "@/components/trailer-buttons"
...
export default async function MoviePage({ params }: MoviePageProps) {
    ...
    const [movie, similarMovies, videos] = await Promise.all([
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                {trailer && <TrailerButton videoKey={trailer.key} title={`${movie.title} - Trailer`} />}
                            </div>
                        </div>
                    </div>
